...
3. Use the provided **"Test_Contracts_List.xlsx"** file for immediate testing.

4. Open `index.html` in your web browser.

5. Click **"Load selected file"** and select the **"Test_Contracts_List"** file.

6. Modify statuses or dates directly in the table and click **"Save Excel report"** to generate the finalized document.
